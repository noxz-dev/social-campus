<template>
  <button
    ...
    class="
      ...
      ease-in-out
      duration-200
      focus:ring-none focus:outline-none focus:ring-2 focus:ring-brand
    "
    aria-pressed="false"
...
export default defineComponent({
  ...
  setup(props, { emit, slots }) {
    ...
    //update the state if its inital state is changed from outside
    watch(
      () => props.initalState,
      () => {
        toggleState.value = props.initalState;
      }
    );
