<template>
  <div v-if="true" class="fixed w-full z-30 overflow-y-auto rounded-xl pt-0.5 backdrop-filter backdrop-blur-[2px]">
    <div class="flex min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
      ...
      <div
        class="inline-block align-bottom bg-white dark:bg-dark-600 rounded-lg text-left overflow-hidden shadow-xl transform transition-all my-8 md:-ml-14 xl:-ml-44 md:align-middle sm:max-w-xl w-full"
        role="dialog"
        aria-modal="true"
