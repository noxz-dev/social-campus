<template>
  <div
    ...
    "
  >
    <div class="dark:text-gray-50 text-gray-900 text-lg border-b-2 w-full border-dark-400 p-2 font-semibold relative">
      <div class="block lg:hidden absolute">
        <div class="rounded-full" @click.stop="$emit('closeNotify')">
          <svg
            class="h-6 w-6"
            viewBox="0 0 24 24"
            version="1.1"
          ...
          >
            ...
            >
              <g id="Close-Square" transform="translate(2.000000, 2.000000)" class="stroke-white" stroke-width="1.5">
