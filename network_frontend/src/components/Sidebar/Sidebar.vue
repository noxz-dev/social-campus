    ...
    const routes = [
      ...
      },
      {
        ...
        icon: `
              ...
              <path class="dark:fill-gray100 fill-gray-500" opacity="0.4" d="M21.9999 15.9402C21.9999 18.7302 19.7599 20.9902 16.9699 21.0002H16.9599H7.04989C4.26989 21.0002 1.99989 18.7502 1.99989 15.9602V15.9502C1.99989 15.9502 2.00589 11.5242 2.01389 9.2982C2.01489 8.8802 2.49489 8.6462 2.82189 8.9062C5.19789 10.7912 9.44689 14.2282 9.49989 14.2732C10.2099 14.8422 11.1099 15.1632 12.0299 15.1632C12.9499 15.1632 13.8499 14.8422 14.5599 14.2622C14.6129 14.2272 18.7669 10.8932 21.1789 8.9772C21.5069 8.7162 21.9889 8.9502 21.9899 9.3672C21.9999 11.5762 21.9999 15.9402 21.9999 15.9402Z" fill="#200E32"/>
              <path id="topMessage" class="dark:fill-gray100 fill-gray-500" d="M21.476 5.6736C20.61 4.0416 18.906 2.9996 17.03 2.9996H7.05001C5.17401 2.9996 3.47001 4.0416 2.60401 5.6736C2.41001 6.0386 2.50201 6.4936 2.82501 6.7516L10.25 12.6906C10.77 13.1106 11.4 13.3196 12.03 13.3196C12.034 13.3196 12.037 13.3196 12.04 13.3196C12.043 13.3196 12.047 13.3196 12.05 13.3196C12.68 13.3196 13.31 13.1106 13.83 12.6906L21.255 6.7516C21.578 6.4936 21.67 6.0386 21.476 5.6736Z" fill="#200E32"/>
              </svg>
            `,
      },
      {
