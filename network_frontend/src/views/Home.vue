<template>
  <div>
    <div
      id="home"
      ref="home"
      class="h-full justify-center bg-white dark:bg-dark-700 md:rounded-3xl transform overflow-x-hidden"
      :class="showSideView && 'overflow-y-hidden'"
    >
      <infinite-scroll-wrapper
        :queryLoading="loading"
        @loadMore="loadMore()"
        class="overflow-y-auto transform inline-block transition-all duration-300"
        :class="showSideView && 'translate-x-[-80%]'"
      >
        <div
          v-if="showSideView"
